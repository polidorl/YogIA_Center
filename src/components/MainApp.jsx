                            ...
                            <div className="relative h-[500px]">
                                ...
                                <div className="absolute inset-x-0 bottom-0 bg-black/60 backdrop-blur-sm p-8 text-center text-white">
                                    ...
                                    <div className="flex items-center justify-center gap-8 mt-5">
                                        <a href="https://www.linkedin.com/in/lisbeth-emperatriz-polidor-solano/" target="_blank" rel="noopener noreferrer" className="text-white/90 hover:text-brand-mint transition-colors transform hover:scale-110">
                                            <Linkedin size={28} />
                                        </a>
            ...
            < footer className="bg-gray-900 text-white py-12 px-6" >
                <div className="max-w-7xl mx-auto flex flex-col items-center gap-8">
                    <div className="flex items-center gap-8">
                        <a href="https://www.linkedin.com/in/lisbeth-emperatriz-polidor-solano/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-mint transition-colors transform hover:scale-110">
                            <Linkedin size={28} />
                        </a>
                        ...
                        <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-mint transition-colors transform hover:scale-110">
                            <Instagram size={28} />
                        </a>
